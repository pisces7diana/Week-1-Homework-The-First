...
// type ls to make sure first_homework is in Desktop folder
// cd first_homework

# In `first_homework`, make a directory named `first_js_homework.js`

// mkdir first_js_homework.js
// type ls to make sure first_js_homework.js is in first_homework folder

# Inside of `first_js_homework.js` make a directory called `terminal_homework.bash`
// cd first_js_homework.js 
// mkdir terminal_homework.bash
// type ls to make sure terminal_homework.bash is in first_js_homework.js folder
// cd terminal_homework.bash
